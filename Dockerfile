...
#RUN apt-get install -y php8.0-mcrypt
...
RUN apt-get install -y php8.0-sqlite3
RUN apt-get install -y php8.0-apcu
RUN apt-get install -y php8.0-memcached
RUN apt-get install -y php8.0-redis
RUN apt-get install -y php8.0-gd
RUN apt-get install -y php8.0-mongodb
...
RUN phpenmod mcrypt
RUN echo "extension=/usr/lib/php/20200930/mcrypt.so" > /etc/php/8.0/cli/conf.d/mcrypt.ini
RUN echo "extension=/usr/lib/php/20200930/mcrypt.so" > /etc/php/8.0/fpm/conf.d/mcrypt.ini
